...
from DCLSUItest_secondv2 import Ui_Details as u2v2
...
class SecondWindowv2(QtGui.QMainWindow,u2v2):
    def __init__(self,parent1, parent2):
        super(SecondWindowv2, self).__init__()  # 初始化父类
        self.setupUi(self)  # 继承 Ui_MainWindow 界面类
        self.result2=Algorithm_result()
        ...
        self.groupBox_trigger.show()
        self.groupBox_vs.hide()
        self.groupBox_Sampling.hide()
        self.groupBox_Delay.hide()
        self.groupBox_Amp_atten.hide()
        self.groupBox_Amp_comp.hide()
        self.groupBox_Pha_comp.hide()
        self.groupBox_VM.hide()
        self.groupBox_IQ.hide()
        self.groupBox_Steps.hide()
        self.groupBox_log.hide()

        # 修改
        #添加逻辑信号
        QtCore.QObject.connect(self.radioButton_trigger, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.show)
        QtCore.QObject.connect(self.radioButton_trigger, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.hide)
        QtCore.QObject.connect(self.radioButton_trigger, QtCore.SIGNAL(_fromUtf8("clicked()")),
        ...
        QtCore.QObject.connect(self.radioButton_trigger, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_log.hide)
        QtCore.QObject.connect(self.radioButton_VS, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.hide)
        QtCore.QObject.connect(self.radioButton_VS, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.show)
        QtCore.QObject.connect(self.radioButton_VS, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_Sampling.hide)
        QtCore.QObject.connect(self.radioButton_VS, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_Delay.hide)
        ...
        QtCore.QObject.connect(self.radioButton_VS, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_log.hide)
        QtCore.QObject.connect(self.radioButton_sampling, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.hide)
        QtCore.QObject.connect(self.radioButton_sampling, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.hide)
        QtCore.QObject.connect(self.radioButton_sampling, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_Sampling.show)
        QtCore.QObject.connect(self.radioButton_sampling, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_Delay.hide)
        QtCore.QObject.connect(self.radioButton_sampling, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_Amp_atten.hide)
        ...
        QtCore.QObject.connect(self.radioButton_sampling, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_log.hide)
        QtCore.QObject.connect(self.radioButton_delay, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.hide)
        QtCore.QObject.connect(self.radioButton_delay, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.hide)
        QtCore.QObject.connect(self.radioButton_delay, QtCore.SIGNAL(_fromUtf8("clicked()")),
        ...
        QtCore.QObject.connect(self.radioButton_delay, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_log.hide)
        QtCore.QObject.connect(self.radioButton_Amp_atten, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.hide)
        QtCore.QObject.connect(self.radioButton_Amp_atten, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.hide)
        QtCore.QObject.connect(self.radioButton_Amp_atten, QtCore.SIGNAL(_fromUtf8("clicked()")),
        ...
        QtCore.QObject.connect(self.radioButton_Amp_atten, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_log.hide)
        QtCore.QObject.connect(self.radioButton_Amp_comp, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.hide)
        QtCore.QObject.connect(self.radioButton_Amp_comp, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.hide)
        QtCore.QObject.connect(self.radioButton_Amp_comp, QtCore.SIGNAL(_fromUtf8("clicked()")),
        ...
        QtCore.QObject.connect(self.radioButton_Amp_comp, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_log.hide)
        QtCore.QObject.connect(self.radioButton_Pha_comp, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.hide)
        QtCore.QObject.connect(self.radioButton_Pha_comp, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.hide)
        QtCore.QObject.connect(self.radioButton_Pha_comp, QtCore.SIGNAL(_fromUtf8("clicked()")),
        ...
        QtCore.QObject.connect(self.radioButton_Pha_comp, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_log.hide)
        QtCore.QObject.connect(self.radioButton_VM, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.hide)
        QtCore.QObject.connect(self.radioButton_VM, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.hide)
        QtCore.QObject.connect(self.radioButton_VM, QtCore.SIGNAL(_fromUtf8("clicked()")),
        ...
        QtCore.QObject.connect(self.radioButton_VM, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_log.hide)
        QtCore.QObject.connect(self.radioButton_IQ, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.hide)
        QtCore.QObject.connect(self.radioButton_IQ, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.hide)
        QtCore.QObject.connect(self.radioButton_IQ, QtCore.SIGNAL(_fromUtf8("clicked()")),
        ...
        QtCore.QObject.connect(self.radioButton_IQ, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_VM.hide)
        QtCore.QObject.connect(self.radioButton_IQ, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_IQ.show)
        QtCore.QObject.connect(self.radioButton_IQ, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_Steps.hide)
        QtCore.QObject.connect(self.radioButton_IQ, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_log.hide)
        QtCore.QObject.connect(self.radioButton_Steps, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.hide)
        QtCore.QObject.connect(self.radioButton_Steps, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.hide)
        QtCore.QObject.connect(self.radioButton_Steps, QtCore.SIGNAL(_fromUtf8("clicked()")),
        ...
        QtCore.QObject.connect(self.radioButton_Steps, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_IQ.hide)
        QtCore.QObject.connect(self.radioButton_Steps, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_Steps.show)
        QtCore.QObject.connect(self.radioButton_Steps, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_log.hide)
        QtCore.QObject.connect(self.radioButton_Log, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_trigger.hide)
        QtCore.QObject.connect(self.radioButton_Log, QtCore.SIGNAL(_fromUtf8("clicked()")),
                               self.groupBox_vs.hide)
        QtCore.QObject.connect(self.radioButton_Log, QtCore.SIGNAL(_fromUtf8("clicked()")),
    ...
    def get_TS_SW(self):
        ...
        self.lineEdit_TS_SWHZset.setStyleSheet(_fromUtf8(""))
        # caput
        return
    def get_TS_EXT(self):
        box = QtGui.QMessageBox()
        ...
        self.lineEdit_TS_SWHZset.setStyleSheet(_fromUtf8("background-color: rgb(217, 217, 217);\n"))
        TS_EXT_status=1
        # caput
        return
    ...
    def get_VMcorrect(self):
        VMcorrect_status = 1
        result_IQ=self.result2.VM_correct()
        # caput
        VM_A = result_IQ[0]
        VM_B = result_IQ[1]
        VM_C = result_IQ[2]
    ...
    def get_IQcorrect(self):
        if (
                self.lineEdit_IQ_Range.text() == '' or self.lineEdit_IQ_Left.text() == '' or self.lineEdit_IQ_Right.text() == '' or self.lineEdit_IQ_Times.text() == '' or self.lineEdit_IQ_WP.text() == ''):
            box = QtGui.QMessageBox()
            ...
            result_IQ=self.result2.IQ_correct(IQ_WP,IQ_Range,IQ_Left,IQ_Right,IQ_Times)
            IQ_A = result_IQ[0]
            IQ_B = result_IQ[1]
            IQ_C = result_IQ[2]
            IQ_D = result_IQ[3]
    ...
    def get_Steps(self):
        if (
            ...
            SP_BW = float(self.lineEdit_SP_BW.text())
            self.result2.Steps(SP_Amp1,SP_Phase1,SP_Amp2,SP_Phase2,SP_BW)
        return
